...
static struct rte_ether_addr client_ether_addr =
    {{0x00, 0x0D, 0x3A, 0x3D, 0x86, 0x0B}};
static uint32_t client_ip_addr = RTE_IPV4(10, 240, 255, 86);


/* the server side */
static struct rte_ether_addr server_ether_addr =
    {{0x00, 0x0D, 0x3A, 0x3D, 0x8F, 0xB0}};
static uint32_t server_ip_addr = RTE_IPV4(10, 240, 255, 180);
